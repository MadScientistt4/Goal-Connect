...
const ClubsMenu = () => {
    ...
    return (
        <div className="container mx-auto bg-background-dark p-4">
            <h1 className='text-5xl font-bold mb-4'>Find Clubs</h1>
            {/* Search bar */} 
            <div className="mb-4">
                <input
                    type="text"
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
                {filteredClubs.map((club, index) => (
                    <div key={index} className="flex flex-col items-center border border-gray-700 shadow-sm shadow-gray-800 bg-card-background p-4 rounded-lg shadow-lg">
                        <img
                            src={club.logo}
                            alt={`${club.name} Logo`}
